...
@property (readwrite, nonatomic) BOOL interruptSeek;

@property (readonly, nonatomic) VideoCacheManager *videoCacheManager;
@property (readwrite, nonatomic) BOOL backgroundMode;
